document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set the current user's name in the profile and sidebar
    ...
    async function loadUserProfile() {
        try {
            ...
            document.getElementById('profileEditName').value = data.username || user.username;
        ...
        try {
            ...
            if (data.contacts && data.contacts.length > 0) {
                ...
                data.contacts.forEach((contact) => {
                    const contactHTML = `
                        <div class="contact" data-username="${contact}">
                            <div class="contact-avatar">
                                <img src="images/shrek-logo.jpg" alt="${contact}">
    ...
    function attachContactEventListeners() {
        ...
        contacts.forEach(contact => {
            ...
            contact.addEventListener('contextmenu', function(e) {
                ...
                document.querySelector('#viewProfilePopup .profile-view-avatar img').src = 'images/shrek-logo.jpg';
